...
$this->pageTitle="Men's Registrations (IITB Students) - Athletics Gala - ". Yii::app()->name;
?>
...
<header id="head" class="secondary"></header>
	...
	<<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Men's Open and Under 18 Category Registrations (IITB Students)</a></li>
		</ol>
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Men's Open and Under 18 Category Registrations (IITB Students)</h1>
				</header>
						...
						<div class="panel-body">
							...
							<form method="post" id="athletics" action="index.php?r=tournament/submit3">
								...
								<div class="top-margin">
									...
									<input type="radio" name="category" value="Men's Open Category" class="form-control">Open<br>
									<input type="radio" name="category" value="Men's Under 18 Category" class="form-control">Under 18
								</div>
								...
								<div class="top-margin">
									...
									<input type="checkbox" name="hurdles110" value="1" class="form-control"> 110m Hurdles
									<input type="checkbox" name="hurdles400" value="1" class="form-control"> 400m Hurdles
									...
									<input type="checkbox" name="triplejump" value="1" class="form-control"> Triple Jump
									...
									<input type="checkbox" name="polevault" value="1" class="form-control"> Pole Vault
