...
<?php include 'sidebar.php'; ?>
    ...
    <!-- Jssor Slider End -->
				...
				<h4>The Indian Institute of Technology, Bombay began in 1958, as one of the five centers of 
                excellence in engineering education, by a special Act of Parliament. The Student Activity 
                Center (SAC) came up in 1980, along with the swimming pool. </h4>
                <h4>The IIT Swimming club started functioning in 1983, under the stewardship of Coach, 
                Dr. P. M. Reddy. It is affiliated to the Greater Mumbai Amateur Aquatic Association(GMAAA).</h4>
