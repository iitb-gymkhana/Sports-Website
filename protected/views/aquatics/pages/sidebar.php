    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav" style="position:relative; left: 50%;-webkit-transform: translateX(-50%);transform: translateX(-50%)">
          <li><a href="index.php?r=<?php echo "$sport2" ?>" style="text-transform:uppercase;"><?php echo "$sport" ?> </a></li>
          ...
          <li><a href="index.php?r=<?php echo "$sport2" ?>/page&view=rules">RULES</a></li>
          <li class="dropdown">
