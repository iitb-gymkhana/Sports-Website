    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
			...
			?>
							...
							<form method="post" id="news" action="index.php?r=about/submitedit" enctype="multipart/form-data">
								<h3 align="center">Title <span class="text-danger">*</span></h3>
									<input type="text" name="title" class="form-control" align="center" style="width 70%" value="<?php echo $msg['title']; ?>"><br><br>
									<h4 align="center" style="display:none">ID <span class="text-danger">*</span></h4>
									<input type="text" name="id" class="form-control" align="center" value="<?php echo $msg['id']; ?>" style="display:none">
									<h4 align="center">DATE<span class="text-danger">*</span></h4>
									<input type="date" name="post_date" class="form-control" value="<?php echo $msg['post_date']; ?>"><br>
			...
			<!--WYSIWYGBegins -->
									    ...
									    <div id="editor" class="form-control"><?php echo $msg['msg']; ?></div>
									    <script>
									        $('#editor').wysiwyg();
									    </script>
									    <textarea id="msg" name="msg" class="form-control" align="center" style="display:none"></textarea>
