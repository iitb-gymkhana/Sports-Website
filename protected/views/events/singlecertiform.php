  ...
  <div class="container" style="margin-top:60px;">
    <div class="row">
      <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
		...
		<form method="post" id="news" action="index.php?r=events/makesinglecerti" enctype="multipart/form-data">
			<h4 align="center">TEMPLATE<span class="text-danger">*</span></h4>
				<select type="text" name="template" class="form-control" required>
					  ...
					  <option value="MERIT">Non-GC Events Merit Certificate</option>
