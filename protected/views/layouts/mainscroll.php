...
<head>
	...
	<script type="text/javascript">
		function fbpopup()
		{
			document.getElementById("fbdropup").classList.add('open');
		}
		function closefbpopup()
		{
			document.getElementById("fbdropup").classList.remove('open');
		}
	</script>
	<script>
	function showSearch()
	...
	<body>
		...
		<div class="container" style="margin-left:0px;margin-right:0px;width:98%">
			<div class="navbar-header" style="position:relative; left:615px;">
				<!-- Button for smallest screens -->
				<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse"><span
				class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
				<a class="navbar-brand" href="index.php"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newlogo.png" style="height:65px;width:60px;margin-left:10px;"alt="IITB Sports Logo"></a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" style="padding-right:70px" data-toggle="dropdown">ABOUT <b class="caret"></b></a>
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" style="padding-right:70px" data-toggle="dropdown">SPORTS <b class="caret"></b></a>
						<ul class="dropdown-menu">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="padding-right:70px">SERVICES <b class="caret"></b></a>
						<ul class="dropdown-menu">
					...
					<li><a href="index.php?r=archive/gallery" style="padding-right:70px">GALLERY</a></li>
