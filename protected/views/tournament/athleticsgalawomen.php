...
$this->pageTitle="Women's Registrations - Athletics Gala - ". Yii::app()->name;
?>
...
<header id="head" class="secondary"></header>
	...
	<<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Women's Open and Under 18 Category Registrations</a></li>
		</ol>
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Women's Open and Under 18 Category Registrations</h1>
				</header>
