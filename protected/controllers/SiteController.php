...
class SiteController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$news = $connection->createCommand()->SELECT('*')->FROM('news')->ORDER('date DESC')->LIMIT(3)->queryAll();
		$event = $connection->createCommand()->SELECT('*')->FROM('events')->ORDER('date DESC')->LIMIT(3)->queryAll();
		$this->render('index',array(
			'news'=> $news,
			'event'=> $event,
			'profile' => $profile,
