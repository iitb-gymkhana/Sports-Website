...
<div id="fh5co-work-section">
			...
			<div class="container">
				<div class="row text-center">
					...
					<div class="col-md-4 col-sm-4">
						<div class="services animate-box">
							<?php if(isset($coach['fb'])){
								$string=$coach['fb'];?>
							<a href="<?php echo $string; ?>" target="_blank" alt="" ><img src="images/council/coach/<?php echo $coach['image']?>" alt="" style="max-height:150px; border-radius:50%"></a><br>
							<?php } ?>
							<br><h3>COACH</h3>
							<p><?php echo $coach['name']; ?><br>
								<?php if(isset($coach['phone'])){ ?>
							<i class="fa fa-phone"></i>  <a style="color:inherit;" href="tel:<?php echo ' ' .$coach['phone'];?>"><?php echo ' ' .$coach['phone']; ?></a><br>
							<?php }
							 ?>
							<?php if(isset($coach['email'])){ ?>
							<a target="_blank" href="mailto:<?php echo $coach['email']?>;" style="color:inherit"><i class="fa fa-envelope"></i> <?php echo $coach['email']?></a><br>
							<?php
						}
						 ?>
						</div>
